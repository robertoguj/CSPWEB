    ...
    var tplPopovers = function (lang, options) {
      ...
      var tplImagePopover = function () {
        ...
        var quarterButton = tplButton('<span class="note-fontsize-10">25%</span>', {
          ...
          event: 'resize',
          value: 'http://paper.kaijuthemes.com/assets/plugins/summernote/dist/0.25'
        });
    ...
    var tplDialogs = function (lang, options) {
      ...
      var tplHelpDialog = function () {
        var body = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + lang.shortcut.close + '</a>' +
                   ...
                   '<p class="text-center">' +
                     '<a href="http://hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.2</a> · ' +
                     '<a href="http://github.com/HackerWins/summernote" target="_blank">Project</a> · ' +
                     '<a href="http://github.com/HackerWins/summernote/issues" target="_blank">Issues</a>' +
                   '</p>';
